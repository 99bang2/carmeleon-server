...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    */
	  try {
		  await queryInterface.addColumn('events', 'operator', {
			  type: Sequelize.STRING
		  });
		  await queryInterface.addColumn('events', 'caution', {
			  type: Sequelize.STRING
		  });
  ...
  down: async (queryInterface, Sequelize) => {
    ...
    */
	  ...
	  // ];
	  try {
		  await queryInterface.removeColumn('events', 'operator');
		  await queryInterface.removeColumn('events', 'caution');
		  return Promise.resolve();
	  } catch (e) {
		  return Promise.reject(e);
	  }
